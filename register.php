...
if(isset($_POST['email'])){
    ...
    if(strlen($password) !== 8) {
        echo '<script>alert("Password harus tepat 8 karakter."); window.location.href="index.php";</script>';
        exit();
    }
    ...
    if($query) {
        ...
        echo '<script>alert("Register Gagal"); window.location.href="index.php";</script>';
        exit();
    }
}
?>
