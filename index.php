    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            align-items: center;
            min-height: 100vh;
            background: url(RU.jpg) no-repeat;
        ...
        .input-box {
            ...
            width: 100%;
            height: 50px;
            border-bottom: 2px solid rgb(25, 47, 95);
            margin: 30px 0;
            display: flex;
            align-items: center;
        }
        ...
        .input-box {
            ...
            width: 100%;
            height: 50px;
            border-bottom: 2px solid rgb(25, 47, 95)3;
            margin: 30px 0;
            display: flex;
            align-items: center;
        }
